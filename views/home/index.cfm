		...
		<div class="body" id="mainBody">
		    <div class="body_vertical_nav clearfix">
				...
				<ul class="vertical_nav">
					<li class="active">
					    <a href="##general_options"><img src="#prc.cbRoot#/includes/images/settings_black.png" alt="modifiers"/> About</a>
                    </li>
					<li>
					    <a href="##tuning_options"><img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> Zones</a>
                    </li>
                    <li>
					    <a href="##tuning_options"><img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> Menus</a>
                    </li>
                    <li>
					    <a href="##tuning_options"><img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> Usage</a>
                    </li>
				</ul>
				<div class="main_column">
    				...
    				<div class="panes_vertical">
        				...
        				<div>
            				<fieldset>
                				<legend>
                				    <img src="#prc.cbRoot#/includes/images/settings_black.png" alt="modifiers"/> <strong>About</strong>
                                </legend>
                                <p>
        				...
        				<div>
        					<fieldset>
        						<legend>
        						    <img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> <strong>Zones</strong>
                                </legend>
        				...
        				<div>
        					<fieldset>
        						<legend>
        						    <img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> <strong>Menus</strong>
                                </legend>
                                <p>The beauty of creating menus with Super Menu is that they are as flexible as you need them to be. You do the following in your menu:</p>
        						<ul class="in-content">
        				...
        				<div>
        					<fieldset>
        						<legend>
        						    <img src="#prc.cbRoot#/includes/images/database_black.png" alt="modifiers"/> <strong>Usage</strong>
                                </legend>
        					</fieldset>
